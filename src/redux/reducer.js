...
// import { addContact, deleteContact, getVisibleContacts } from './action';
...
// export const contactsReducer = createReducer(initionalContacts, {
...
// export const contactsReducer = (state = initionalContacts, action) => {
//   switch (action.type) {
